...
class privados
{
    ...
    function totalVendaPrivados($data_evento = false)
    {
        ...
        $query = "SELECT SUM(venda_privados.valor_multibanco_adiantado) as valor_multibanco_adiantado, SUM(venda_privados.valor_dinheiro_adiantado) as valor_dinheiro_adiantado, SUM(venda_privados.valor_mbway_adiantado) as valor_mbway_adiantado, SUM(venda_privados.valor_transferencia_bancaria_adiantado) as valor_transferencia_bancaria_adiantado, SUM(venda_privados.valor_multibanco_adiantado + venda_privados.valor_dinheiro_adiantado + venda_privados.valor_mbway_adiantado + venda_privados.valor_transferencia_bancaria_adiantado) as total_adiantado, SUM(venda_privados.valor_multibanco) as valor_multibanco, SUM(venda_privados.valor_dinheiro) as valor_dinheiro, SUM(venda_privados.valor_mbway) as valor_mbway, SUM(venda_privados.valor_multibanco + venda_privados.valor_dinheiro + venda_privados.valor_mbway) as total_evento, SUM(venda_privados.total) as total FROM venda_privados $where ORDER BY id DESC";
        $res = $this->db->query($query);
