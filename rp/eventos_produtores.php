...
$eventos = $dbrp->listaEventosProdutores();
?>
	...
	?>
			<div class="evento">
				...
				<div class="rodape">
					...
					<span class="item">
						<span class="titulo">
							Melhor Equipa (Entradas)
						</span>
						<span class="valor">
							<?php echo $evento['melhor_equipa_entradas']; ?>
						</span>
					</span>
					<span class="item">
						<span class="titulo">
				...
				<div class="links">
					...
					?>
						<a href="/rp/index.php?pg=eventos_produtores_equipas&data_evento=<?php echo $evento['data_evento_sql']; ?>" class="ver_entradas"> Ver entradas por equipa </a>
					<?php
					}
					if ($evento['numero_privados']) {
					?>
						<a href="/rp/index.php?pg=eventos_produtores_privados&data_evento=<?php echo $evento['data_evento_sql']; ?>" class="ver_vendas"> Ver vendas de privados</a>
					<?php
					}
					?>
				</div>
