                    ...
                    <div class="swiper-slide" id="sala_<?php echo $sala['id']; ?>" data-hash="sala_<?php echo $sala['id']; ?>">
                        ...
                        ?>
                            <div class="hotspot">
                                ...
                                ?>
                                    <a class="mesa <?php if ($vendida) { ?> vendida <?php } else if ($disponivel == 1) { ?> livre <?php } else { ?> ocupado <?php } ?>" id="mesa_<?php echo $sala['id'] . "_" . $mesa['codigo_mesa']; ?>" <?php if ($permissao) { ?> href="/rp/index.php?pg=inserir_reserva&id=0&id_mesa=<?php echo $mesa['id']; ?>&data_evento=<?php echo $data_evento; ?>" <?php } ?>>
