...
- Agora totalmente compat&iacute;vel com Blocos (WooCommerce Blocks).
- Foram corrigidas algumas incompatibilidades, tornando o plugin mais eficiente.
- Agora &eacute; poss&iacute;vel enviar ou atualizar os URLs de callback para notifica&ccedil;&otilde;es em tempo real.
- Cria&ccedil;&atilde;o de uma nova p&aacute;gina para configurar o plugin.
...
- Now fully compatible with Blocks (WooCommerce Blocks).
- Some incompatibilities have been fixed, making the plugin more efficient.
- It is now possible to send or update callback URLs for real-time notifications.
- Creation of a new page to configure the plugin.
